...
using FirmaXadesNetCoreUpdated.Utils;
using FirmaXadesNetCoreUpdated.Validation;
...
{
    public class XadesServiceManager : FirmaXadesNetCore.XadesService
    {
        ...
        public SignatureDocument CoSign(SignatureDocument sigDocument, SignatureParameters parameters)
        {
            ...
            coSignatureDocument.XadesSignature = new XadesSignedXmlUpdated(coSignatureDocument.Document);
        ...
        public SignatureDocument CounterSign(SignatureDocument sigDocument, SignatureParameters parameters)
        {
            ...
            XadesSignedXmlUpdated counterSignature = new XadesSignedXmlUpdated(counterSigDocument.Document);
            ...
            counterSigDocument.XadesSignature = new XadesSignedXmlUpdated(counterSigDocument.Document);
        ...
        /// <param name="sigDocument"></param>
        /// <returns></returns>
        public FirmaXadesNetCoreUpdated.Validation.ValidationResult Validate(SignatureDocument sigDocument)
        {
            SignatureDocument.CheckSignatureDocument(sigDocument);
            //sigDocument.XadesSignature;
        ...
        /// </summary>
        private void SetSignatureId(XadesSignedXmlUpdated xadesSignedXml)
        {
        ...
        private void SetContentInternallyDetached(SignatureDocument sigDocument, Stream input)
        {
            ...
            _refContent.Uri = "#" + id;
            _refContent.Id = "Reference-" + Guid.NewGuid().ToString();
            _refContent.Type = XadesSignedXmlUpdated.XmlDsigObjectType;
        ...
        private void SetContentEveloping(SignatureDocument sigDocument, XmlDocument xmlDocument)
        {
            ...
            sigDocument.XadesSignature = new XadesSignedXmlUpdated();
