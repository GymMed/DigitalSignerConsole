...
namespace FirmaXadesNetCoreUpdated.Crypto
{
    public class SignerUpdated : Signer, IDisposable
    {
        ...
        public new AsymmetricAlgorithm SigningKey
        {
            set
            {
                _signingKey = value;
        ...
        public SignerUpdated(X509Certificate2 certificate) : base(certificate)
        {
            if (certificate == null)
            {
