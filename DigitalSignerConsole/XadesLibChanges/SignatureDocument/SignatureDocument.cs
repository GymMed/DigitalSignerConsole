...
namespace FirmaXadesNetCoreUpdated.Signature
{
    public class SignatureDocument
    {
        #region Private variables        

        private XadesSignedXmlUpdated _xadesSignedXml;
        ...
        public XadesSignedXmlUpdated XadesSignature
        {
            get
            {
        ...
        internal void UpdateDocument()
        {
            ...
            if (_document.DocumentElement != null)
            {
                ...
                if (xmlNode != null)
                {
                    ...
                    nm.AddNamespace("xades", XadesSignedXmlUpdated.XadesNamespaceUri);
                    ...
                    if (xmlUnsingedPropertiesNode != null)
                    {
                        ...
                        {
                            foreach (XadesSignedXmlUpdated counterSign in _xadesSignedXml.XadesObject.QualifyingProperties.UnsignedProperties.UnsignedSignatureProperties.CounterSignatureCollection)
                            {
                                if (xmlNode.SelectSingleNode("//*[@Id='" + counterSign.Signature.Id + "']") == null)
                                {
                                    XmlNode xmlCounterSignatureNode = _document.CreateElement(XadesSignedXmlUpdated.XmlXadesPrefix, "CounterSignature", XadesSignedXmlUpdated.XadesNamespaceUri);
